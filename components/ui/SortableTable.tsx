...
export default function SortableTable<T extends Record<string, any>>({
  ...
  return (
    <div className={`bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg overflow-hidden border border-gray-100 ${className}`}>
        ...
        <table className="w-full">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {sortedData.map((row, rowIndex) => (
              ...
              >
                {columns.map((column) => (
                  <td key={String(column.key)} className="px-8 py-5 whitespace-nowrap">
                    {column.render
